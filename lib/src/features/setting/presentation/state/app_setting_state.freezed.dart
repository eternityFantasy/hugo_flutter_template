...
mixin _$AppSettingState {
  AppCurrentTheme? get appCurrentTheme => throw _privateConstructorUsedError;
...
abstract class $AppSettingStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AppCurrentTheme? appCurrentTheme});
}
...
class _$AppSettingStateCopyWithImpl<$Res, $Val extends AppSettingState>
  ...
  @override
  $Res call({
    Object? appCurrentTheme = freezed,
  }) {
    return _then(_value.copyWith(
      appCurrentTheme: freezed == appCurrentTheme
          ? _value.appCurrentTheme
          : appCurrentTheme // ignore: cast_nullable_to_non_nullable
              as AppCurrentTheme?,
    ) as $Val);
  }
}
...
class _$AppSettingStateImpl implements _AppSettingState {
  const _$AppSettingStateImpl({this.appCurrentTheme = null});

  @override
  @JsonKey()
  final AppCurrentTheme? appCurrentTheme;

  @override
  String toString() {
    return 'AppSettingState(appCurrentTheme: $appCurrentTheme)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.appCurrentTheme, appCurrentTheme) ||
                other.appCurrentTheme == appCurrentTheme));
  }

  @override
  int get hashCode => Object.hash(runtimeType, appCurrentTheme);
...
abstract class _AppSettingState implements AppSettingState {
  const factory _AppSettingState({final AppCurrentTheme? appCurrentTheme}) =
      _$AppSettingStateImpl;

  @override
  AppCurrentTheme? get appCurrentTheme;
